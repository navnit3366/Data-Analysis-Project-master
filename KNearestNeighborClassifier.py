...
# levels, glucose levels, and chronic kidney disease (CKD). Create n number of random test cases and 
# determine whether the case is likely to have CKD depending on the mode of the classifications of 
# the k number of nearest points.
...
# This is the same as for NearestNeighbor, except you will be doing a query of k number of points.
