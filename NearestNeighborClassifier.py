...
# Name: Alycia Wong
# Date: June 2020
# Description: Use this to brush up on Python syntax (I reccomend Google 🤪). 
# Process and graph a CSV file containing biomedical data that relates hemoglobin levels, glucose 
# levels, and chronic kidney disease (CKD). Create n number of random test cases and determine 
# whether the case is likely to have CKD depending on the classification of the nearest point. 
...
# Functions
# =================================================================================================
# openCSVFile function takes in no arguments and parses/organizes data from a CSV file into a 
# 2-D numpy array with the columns being: hemoglobin, glucose, classification and each row being 
# a case.
...
# nearestNeighborIndex function takes in a 2D array of cartesian points and a randomly generated test
# case. Returns the index of the closest point in the 2D array to the test case. 
# Method 1: Use indices and the distance function to create an array of points and return the index
# of the closest point. 
# Method 2: Use KDTree 
# If you do this, you will not need to use the distance formula since this uses a spatial library
